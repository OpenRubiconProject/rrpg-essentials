...
break | essentials.break | Allows access to the /break command.
 ...
 killall | essentials.killall | Allows access to the /killall command.
...
--- | --- | --- 
 ...
 enchant | essentials.enchant.[enchantmentname] | Allows access to each enchantment type.
 ...
 give | essentials.give.item- | If permission-based-item-spawn: Spawn
 give | essentials.give.item-[itemid] | If permission-based-item-spawn: Spawn [itemid]
 give | essentials.give.item-all | If permission-based-item-spawn: Spawn all items
 ...
 kit | essentials.kit.* | Allows access to all created kits (and giving kits to others).
 kit | essentials.kit.[kitname] | Where [kitname] is the name of an existing kit.
 ...
 eco | essentials.eco.loan | Gives the player unlimited money.
 ...
 getpos | essentials.list.hidden | Allows user to get position of a hidden player.
 ...
 whois | essentials.list.hidden | Show hidden users
 ban | essentials.ban.exempt | Prevents a specified group or player from being banned
 ban | essentials.ban.notify | User sees a notification when a ban is set.
 ...
 kick | essentials.kick.exempt | Prevents a specified group or player from being kicked
 kick | essentials.kick.notify | User sees a notification when a user is kicked.Moderator | mute | essentials.mute.exempt | Prevents a specified group or player from being muted
 ...
 vanish | essentials.list.hidden | Allows players to see vanished players in commands like /list, /getpos and /whois
 vanish | essentials.teleport.hidden | Allows players to teleport to vanished players with /tpo and /tpohere
 ...
 tpall | essentials.world. | Allows players access to a specific world.
 tphere | essentials.world. | Allows players access to a specific world.
 tpo | essentials.teleport.hidden | Allows teleporting to a hidden player
 home | essentials.home.others | Allows you to teleport to homes of other players
 home | essentials.world. | Allows players access to a specific world.
 ...
 back | essentials.world. | Allows players access to a specific world.
 delhome | essentials.delhome.others | Allows you to delete the homes of other players.
 tpaall | essentials.world. | Allows players access to a specific world.
 tpa | essentials.world. | Allows players access to a specific world.
 tpahere | essentials.world. | Allows players access to a specific world.
 tptoggle | essentials.teleport.cooldown.bypass | Bypass the teleport cooldown
 tptoggle | essentials.teleport.hidden | Allows the user to teleport to players who are hidden by another plugin. This permission only affects tpo and tpohere.
 ...
 tp | essentials.world. | Allows players access to a specific world.
 tpo | essentials.world. | Allows players access to a specific world.
 tpohere | essentials.teleport.hidden | Allows teleporting a hidden player
 tpohere | essentials.world. | Allows players access to a specific world.
 warp | essentials.warp.* | Allows access to all warps.
 warp | essentials.warp.[warpname] | If you have per-warp-permission set to true in the config.yml then you can limit what warps players can use. This also controls what players would see with /warp.

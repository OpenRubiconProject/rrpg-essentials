...
Moderator	killall	essentials.killall	Allows access to the /killall command.
...
Cheat	enchant	essentials.enchant.[enchantmentname]	Allows access to each enchantment type.
Cheat	exp	essentials.exp.give	Allows players to give themselves exp.
Cheat	exp	essentials.exp.give.others	Allows players to give others exp (if they also have essentials.exp.give).
...
Cheat	exp	essentials.exp.set.others	Allows players to change others exp (if they also have essentials.exp.set).
...
Cheat	gamemode	essentials.gamemode.others	Allows you to change the gamemode of other players.
Cheat	give	essentials.give.item-	If permission-based-item-spawn: Spawn
Cheat	give	essentials.give.item-[itemid]	If permission-based-item-spawn: Spawn [itemid]
Cheat	give	essentials.give.item-all	If permission-based-item-spawn: Spawn all items
...
Cheat	kit	essentials.kit.*	Allows access to all created kits (and giving kits to others).
Cheat	kit	essentials.kit.[kitname]	Where [kitname] is the name of an existing kit.
...
Economy	eco	essentials.eco.loan	Gives the player unlimited money.
...
General	getpos	essentials.list.hidden	Allows user to get position of a hidden player.
...
General	whois	essentials.list.hidden	Show hidden users
Moderator	ban	essentials.ban.exempt	Prevents a specified group or player from being banned
Moderator	ban	essentials.ban.notify	User sees a notification when a ban is set.
...
Moderator	kick	essentials.kick.exempt	Prevents a specified group or player from being kicked
Moderator	kick	essentials.kick.notify	User sees a notification when a user is kicked.Moderator	mute	essentials.mute.exempt	Prevents a specified group or player from being muted
...
Moderator	vanish	essentials.list.hidden	Allows players to see vanished players in commands like /list, /getpos and /whois
Moderator	vanish	essentials.teleport.hidden	Allows players to teleport to vanished players with /tpo and /tpohere
...
Teleport	sethome	essentials.sethome.multiple.[set]	Raise the multiple home limit to a setting defined in the config file.
...
Teleport	tpall	essentials.world.	Allows players access to a specific world.
Teleport	tphere	essentials.world.	Allows players access to a specific world.
...
Teleport	home	essentials.world.	Allows players access to a specific world.
...
Teleport	back	essentials.world.	Allows players access to a specific world.
Teleport	delhome	essentials.delhome.others	Allows you to delete the homes of other players.
Teleport	tpaall	essentials.world.	Allows players access to a specific world.
Teleport	tpa	essentials.world.	Allows players access to a specific world.
Teleport	tpahere	essentials.world.	Allows players access to a specific world.
Teleport	tptoggle	essentials.teleport.cooldown.bypass	Bypass the teleport cooldown
Teleport	tptoggle	essentials.teleport.hidden	Allows the user to teleport to players who are hidden by another plugin. This permission only affects tpo and tpohere.
...
Teleport	tp	essentials.world.	Allows players access to a specific world.
Teleport	tpo	essentials.world.	Allows players access to a specific world.
Teleport	tpohere	essentials.teleport.hidden	Allows teleporting a hidden player
Teleport	tpohere	essentials.world.	Allows players access to a specific world.
Teleport	warp	essentials.warp.*	Allows access to all warps.
Teleport	warp	essentials.warp.[warpname]	If you have per-warp-permission set to true in the config.yml then you can limit what warps players can use. This also controls what players would see with /warp.
